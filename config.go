...
func config() Configuration {
	statusUrlPtr := flag.String("url", "http://127.0.0.1/server_status", "Url of the php-fpm status page")
	...
	metricsPrefixPtr := flag.String("metrics-prefix", "server.phpfpm", "Prefix to prepend metrics names")
